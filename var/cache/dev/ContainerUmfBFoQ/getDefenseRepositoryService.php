 ...
 */
class getDefenseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DefenseRepository' shared autowired service.
     *
     * @return \App\Repository\DefenseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DefenseRepository.php';

        return $container->privates['App\\Repository\\DefenseRepository'] = new \App\Repository\DefenseRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
